            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        <x-nav-link :href="route('dashboard.campaigns.index')" :active="request()->routeIs('dashboard.campaigns.*')">
                            {{ __('My Campaigns') }}
                        </x-nav-link>
                        <x-nav-link :href="route('dashboard.donations')" :active="request()->routeIs('dashboard.donations')">
                            {{ __('My Donations') }}
                        </x-nav-link>
                    @endauth
                </div>
