                ...
                <div class="p-8">
                    @if(session('success'))
                        <div x-data="{ show: true }"
                             ...
                             class="mb-6 p-4 bg-green-50 border-l-4 border-green-400 text-green-700 flex justify-between items-center">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            @forelse($campaigns as $campaign)
                                <tr>
                                    ...
                                    <td class="py-4 text-right">
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <button x-data @click="$dispatch('open-modal', 'confirm-delete-{{ $campaign->id }}')" class="p-2 text-gray-400 hover:text-red-600 transition">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <x-modal-confirm name="confirm-delete-{{ $campaign->id }}" title="Delete Campaign?">
                                    <form method="POST" action="{{ route('dashboard.campaigns.destroy', $campaign->id) }}">
                                        @csrf
                                        @method('DELETE')
