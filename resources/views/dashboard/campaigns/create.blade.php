                    ...
                    <form action="{{ route('dashboard.campaigns.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('title')" required autofocus placeholder="e.g. Help Build a Community Library" />
                            ...
                            <div>
                                ...
                                <x-text-input id="short_description" class="block mt-1 w-full" type="text" name="short_description" :value="old('short_description')" required placeholder="A brief catchphrase for your campaign" />
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="6" class="border-gray-300 focus:border-teal-500 focus:ring-teal-500 rounded-md shadow-sm block mt-1 w-full" required placeholder="Tell your story and explain why people should donate...">{{ old('description') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <x-text-input id="target_amount" class="block w-full pl-10" type="number" name="target_amount" :value="old('target_amount')" required min="10000" step="1" placeholder="0" />
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="mt-2 flex items-center space-x-6">
                                    <div class="shrink-0">
                                        <img id="preview" class="h-16 w-16 object-cover rounded-lg bg-gray-100" src="https://ui-avatars.com/api/?name=C&color=0D9488&background=CCFBF1" alt="Preview">
                                    </div>
                                    <label class="block">
